...
if(SPARTA_ENABLE_TESTING)
  ...
  set(SPARTA_DISABLED_TESTS
      ...
      "in.swpm.bkw" # Requires bkw.particles generated by bkw_init.py
      "in.swpm.1D" # Demonstration example; wall tallies not bit-reproducible
                   # across rank counts (see header). Coverage: in.swpm.boundary
  )
  ...
  if(SPARTA_KOKKOS_EXACT)
    list(APPEND SPARTA_DISABLED_TESTS
        ...
        "in.bfield"
        "in.bfield.grid"
        # stochastic weighted particle method (SWPM) not KOKKOS-enabled
        "in.swpm.1D"
        "in.swpm.boundary"
