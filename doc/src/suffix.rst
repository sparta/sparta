...
As an example, the KOKKOS package provides a :doc:`compute\_style temp <compute_temp>` variant, with style name temp/kk. A variant
...
new :doc:`fix <fix>`, :doc:`compute <compute>`, etc.  If the variant
