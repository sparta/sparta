...
examples can be viewed on the Movies section of the `SPARTA WWW Site <sws_>`_.

See the examples/README file for more details on the example sub
directories including a one-line description of each.
