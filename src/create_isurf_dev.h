...
CommandStyle(create_isurf_dev,CreateISurfDev)

#else

#ifndef SPARTA_CREATE_ISURF_DEV_H
#define SPARTA_CREATE_ISURF_DEV_H
...
class CreateISurfDev : protected Pointers {
 public:
  CreateISurfDev(class SPARTA *);
  virtual ~CreateISurfDev();
