...
FixStyle(emit/surf_timeavg,FixEmitSurfTimeAvg)

#else

#ifndef SPARTA_FIX_EMIT_SURF_TIMEAVG_H
#define SPARTA_FIX_EMIT_SURF_TIMEAVG_H
...
class FixEmitSurfTimeAvg : public FixEmit {
 public:
  FixEmitSurfTimeAvg(class SPARTA *, int, char **);
  ~FixEmitSurfTimeAvg();
  void init();
  void setup();
