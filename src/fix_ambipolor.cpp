...
FixAmbipolor::FixAmbipolor(SPARTA *sparta, int narg, char **arg) :
  Fix(sparta, narg, arg)
{
...
void FixAmbipolor::update_custom(int index, double temp_thermal,
                                double, double,
                                double *vstream)
{
...
void FixAmbipolor::surf_react(Particle::OnePart *iorig, int &i, int &j)
{
