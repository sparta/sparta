...
ComputeStyle(eflux/grid/sw,ComputeEFluxGridSW)

#else

#ifndef SPARTA_COMPUTE_EFLUX_GRID_SW_H
#define SPARTA_COMPUTE_EFLUX_GRID_SW_H

#include "compute.h"

namespace SPARTA_NS {

class ComputeEFluxGridSW : public Compute {
 public:
  ComputeEFluxGridSW(class SPARTA *, int, char **);
  ~ComputeEFluxGridSW();
  void init();
