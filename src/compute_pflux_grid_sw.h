...
ComputeStyle(pflux/grid/sw,ComputePFluxGridSW)

#else

#ifndef SPARTA_COMPUTE_PFLUX_GRID_SW_H
#define SPARTA_COMPUTE_PFLUX_GRID_SW_H

#include "compute.h"

namespace SPARTA_NS {

class ComputePFluxGridSW : public Compute {
 public:
  ComputePFluxGridSW(class SPARTA *, int, char **);
  ~ComputePFluxGridSW();
  void init();
