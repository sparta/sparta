...
ComputeStyle(vmom/grid,ComputeVmomGrid)

#else

#ifndef SPARTA_COMPUTE_VMOM_GRID_H
#define SPARTA_COMPUTE_VMOM_GRID_H

#include "compute.h"

namespace SPARTA_NS {

class ComputeVmomGrid : public Compute {
 public:
  ComputeVmomGrid(class SPARTA *, int, char **);
  ~ComputeVmomGrid();
  void init();
