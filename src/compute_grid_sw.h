...
ComputeStyle(grid/sw,ComputeGridSW)

#else

#ifndef SPARTA_COMPUTE_GRID_SW_H
#define SPARTA_COMPUTE_GRID_SW_H

#include "compute.h"

namespace SPARTA_NS {

class ComputeGridSW : public Compute {
 public:
  ComputeGridSW(class SPARTA *, int, char **);
  ~ComputeGridSW();
  void init();
...
E: Invalid call to ComputeGridSW::post_process_grid()
