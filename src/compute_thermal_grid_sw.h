...
ComputeStyle(thermal/grid/sw,ComputeThermalGridSW)

#else

#ifndef SPARTA_COMPUTE_THERMAL_GRID_SW_H
#define SPARTA_COMPUTE_THERMAL_GRID_SW_H

#include "compute.h"

namespace SPARTA_NS {

class ComputeThermalGridSW : public Compute {
 public:
  ComputeThermalGridSW(class SPARTA *, int, char **);
  ~ComputeThermalGridSW();
  void init();
